  ...
  return (
    <div className="overflow-x-clip">
            ...
            <div className="lg:col-span-7">
              ...
              >
                <span className="flex items-center gap-0.5 sm:gap-1">
                  {[1, 2, 3, 4, 5].map((s) => (
                    <Star key={s} className="w-3 sm:w-3.5 h-3 sm:h-3.5 text-coral-500 fill-coral-500" />
                  ))}
                </span>
                <span className="text-[11px] sm:text-sm font-medium text-ink-200">
              ...
              >
                <Link href="/contact" className="w-full sm:w-auto">
                  <MagneticButton strength={0.15}>
                    <span className="btn-primary gap-2 h-11 px-5 sm:px-6 text-sm font-semibold rounded-lg w-full sm:w-auto justify-center group shadow-sm">
                ...
                <a href={`tel:${hospitalInfo.phone}`} className="w-full sm:w-auto">
                  <MagneticButton strength={0.15}>
                    <span className="btn-outline gap-2 h-11 px-5 sm:px-6 text-sm font-semibold rounded-lg w-full sm:w-auto justify-center group">
              ...
              >
                {hospitalInfo.accreditations.map((acc) => (
                  <div key={acc} className="flex items-center gap-2.5 sm:gap-3">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-teal-50 flex items-center justify-center shrink-0">
                ...
                <div className="flex items-center gap-2.5 sm:gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] sm:text-[11px] text-ink-50 leading-tight">Per Month</div>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-card border border-gray-100/80 bg-white">
                ...
                >
                  ...
                  <div className="text-[10px] sm:text-[11px] text-ink-50 flex items-center gap-1">
                    <Star className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-coral-500 fill-coral-500 shrink-0" />
                ...
                >
                  <div className="flex items-center gap-2 sm:gap-2.5 mb-1.5 sm:mb-2">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-coral-500/10 flex items-center justify-center shrink-0">
                      <Clock className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-coral-500" />
                    </div>
                    <div>
                      <div className="text-[9px] sm:text-[10px] uppercase tracking-wider text-ink-50 font-semibold leading-tight">
                        24/7 Support
                      </div>
                  ...
                  <div className="text-[9px] sm:text-[10px] text-ink-50 mt-1 sm:mt-1.5">Immediate Response Time</div>
                </motion.div>
              </div>
            </motion.div>
          </div>
            ...
            {specialities.slice(0, 6).map((spec, i) => {
              ...
              return (
                ...
                >
                  <Link
                    href="/specialities"
                    className="group card card-hover p-5 sm:p-6 flex flex-col justify-between h-full border border-gray-100/80 hover:border-coral-400/80 transition-all duration-300"
                  >
                    <div>
                      <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-teal-50 group-hover:bg-coral-500 flex items-center justify-center mb-3 sm:mb-4 transition-all duration-300 group-hover:scale-105">
                        <Icon className="w-5 h-5 text-teal-600 group-hover:text-white transition-colors duration-300" />
                      </div>
                      <h4 className="heading-display text-lg sm:text-h4 mb-2 leading-snug group-hover:text-teal-700 transition-colors">
                        {spec.name}
                      </h4>
                      <p className="text-xs sm:text-sm text-ink-50 leading-relaxed line-clamp-3">
                        {spec.shortDescription}
                      </p>
                    </div>
                    <div className="pt-3 sm:pt-4 mt-3 sm:mt-4 border-t border-gray-50 flex items-center text-xs font-semibold text-teal-600 group-hover:text-coral-500 transition-colors">
      ...
      <section className="py-10 sm:py-16 lg:py-20">
        <div className="container-lg">
          <div className="relative rounded-2xl bg-gradient-to-br from-teal-600 via-teal-700 to-teal-800 p-6 sm:p-8 lg:p-12 overflow-hidden">
            <div className="absolute inset-0 opacity-20 pointer-events-none">
              <div className="absolute top-[-50%] right-[-20%] w-[320px] sm:w-[500px] h-[320px] sm:h-[500px] bg-coral-500 rounded-full blur-3xl" />
            </div>
            <div className="relative grid lg:grid-cols-12 gap-6 sm:gap-8 items-center">
              <Reveal className="lg:col-span-8">
                <h2 className="heading-display text-2xl sm:text-h2 text-white mb-3 sm:mb-4 max-w-2xl leading-snug sm:leading-tight">
